    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--info has-link box--shadow2 overflow-hidden">
                <a class="item-link" href="{{ route('admin.report.invest') }}"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="lar la-credit-card f-size--56"></i>
                        </div>
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Total Invest')</span>
                            <h2 class="text-white">{{ $general->cur_sym }}{{ showAmount($widget['total_invest']) }}</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg--success has-link box--shadow2">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Last 7 Days Invest')</span>
                            <h2 class="text-white">{{ $general->cur_sym }}{{ showAmount($widget['last7days_invest']) }}
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--primary has-link box--shadow2">
                <a class="item-link" href="{{ route('admin.report.referral.commission') }}"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="las la-hand-holding-usd f-size--56"></i>
                        </div>
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Total Referral Commission')</span>
                            <h2 class="text-white">{{ $general->cur_sym }}{{ showAmount($widget['total_ref_com']) }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--red has-link box--shadow2">
                <a class="item-link" href="{{ route('admin.report.binary.commission') }}"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="las la-tree f-size--56"></i>
                        </div>
                        <div class="col-8 text-end">
                            <span class="text--small text-white">@lang('Total Binary Commission')</span>
                            <h2 class="text-white">{{ $general->cur_sym }}{{ showAmount($widget['total_binary_com']) }}
                            </h2>
                        </div>
                    </div>
                </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ getAmount($widget['totalBvCut']) }}</h3>
                    <p>@lang('Users Total Bv Cut')</p>
                </div>
                <a class="widget-two__btn border--success btn-outline--success border" href="{{ route('admin.report.bvLog') }}?type=cutBV">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ getAmount($widget['bvLeft'] + $widget['bvRight']) }}</h3>
                    <p>@lang('Users Total BV')</p>
                </div>
                <a class="widget-two__btn border--warning btn-outline--warning border" href="{{ route('admin.report.bvLog') }}?type=paidBV">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ getAmount($widget['bvLeft']) }}</h3>
                    <p>@lang('Users Left BV')</p>
                </div>
                <a class="widget-two__btn border--danger btn-outline--danger border" href="{{ route('admin.report.bvLog') }}?type=leftBV">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ getAmount($widget['bvRight']) }}</h3>
                    <p>@lang('Right BV')</p>
                </div>
                <a class="widget-two__btn border--primary btn-outline--primary border" href="{{ route('admin.report.bvLog') }}?type=rightBV">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
